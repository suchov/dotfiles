...
Plug 'scrooloose/nerdtree' " just a neerdrtee - love it
Plug 'bling/vim-airline' " status line for vim - this at the bottom of the page
Plug 'tomtom/tcomment_vim' " gc comments
Plug 'tpope/vim-surround' " cool change surrounding wit cs combination
Plug 'tpope/vim-commentary' " gcc to comment the sring gcap - to comment the paragraph
Plug 'neomake/neomake', { 'for': ['rust', 'haskell', 'typescript'] } " async linting
Plug 'airblade/vim-gitgutter' " show the changed lines with +
